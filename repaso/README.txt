...
a persistence unit "repasoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "repaso/pom.xml":
...
artifact ("repaso.war") is already built. You can build
